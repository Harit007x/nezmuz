    ...
    <PageLayout>
      <section className="mx-auto w-full max-w-6xl px-6 py-32 border-t border-white/[0.05]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-32">
          <div className="rounded-3xl border border-white/[0.08] bg-zinc-950 p-8">
            <h3 className="mb-3 text-lg font-medium tracking-tight text-zinc-100">Mission</h3>
            <p className="text-sm leading-relaxed text-zinc-400">To engineer scalable, secure, and beautiful software that accelerates human potential and business growth.</p>
          </div>
          <div className="rounded-3xl border border-white/[0.08] bg-zinc-950 p-8">
            <h3 className="mb-3 text-lg font-medium tracking-tight text-zinc-100">Vision</h3>
            <p className="text-sm leading-relaxed text-zinc-400">To be the trusted technical partner for the world's most innovative startups and forward-thinking enterprises.</p>
          </div>
          <div className="rounded-3xl border border-white/[0.08] bg-zinc-950 p-8">
            <h3 className="mb-3 text-lg font-medium tracking-tight text-zinc-100">Values</h3>
            <p className="text-sm leading-relaxed text-zinc-400">Radical transparency, uncompromising quality, continuous learning, and human-centric design.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="flex flex-col items-center justify-center rounded-3xl border border-white/[0.08] bg-zinc-950 p-8 text-center hover:border-zinc-700 transition-colors">
